...
import AdminRoleManagementPage from "./components/pages/AdminRoleManagementPage";
import OAuthLoginPage from "./components/pages/OAuthLoginPage";
...
function AppContent() {
  ...
  const userAvatar = currentUser?.avatar || "https://i.pravatar.cc/100";
    ...
    <div className="flex h-screen bg-[#F8FAFC] font-sans">
      <aside className="w-[84px] lg:w-[280px] bg-[#061224] text-white flex flex-col h-full flex-shrink-0 shadow-2xl transition-all duration-300 relative z-30">
        ...
        >
          ...
          <span className="text-2xl font-black tracking-tight hidden lg:block">
            UniOps
          </span>
        </Link>
        ...
        <div className="mt-auto p-6 mb-4 space-y-3">
          <div className="bg-white/5 rounded-2xl p-4 hidden lg:block border border-white/10 mb-2">
            <p className="text-[10px] font-black uppercase tracking-[2px] text-blue-400 mb-2">
              Pro Support
            </p>

            <p className="text-xs text-gray-400 font-medium leading-relaxed">
              Need help with your {userRole.toLowerCase()} portal?
            </p>

            <button className="mt-4 w-full py-2 bg-white/10 hover:bg-white/20 text-white text-[10px] font-black uppercase tracking-widest rounded-xl transition-all">
              Contact Dev
            </button>
          </div>
          ...
          <div className="flex items-center gap-10">
            <div className="flex items-center gap-3 pr-6 border-r border-gray-100">
              <button
                ...
                className="p-2.5 text-gray-400 hover:text-[#061224] transition-colors relative"
              >
            ...
            <div className="flex items-center gap-4 group cursor-pointer">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-black text-[#061224] leading-none mb-1">
                  {userName}
                </p>
          ...
          <div className="p-8 pb-20">
            <Routes>
              ...
              <Route
                path="/resources"
                element={
                  userRole === "ADMIN" ? <AdminResourcesPage /> : <ResourcesPage />
                }
              />
              ...
              <Route
                ...
                element={
                  userRole === "TECHNICIAN" ? (
                    ...
                    <AccessDenied message="This portal is reserved for technicians." />
                  )
                }
              />
              ...
              <Route
                ...
                element={
                  userRole === "ADMIN" ? (
                    ...
                    <AccessDenied message="Only admins can access role management." />
                  )
                }
              />
